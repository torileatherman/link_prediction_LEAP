...
parser.add_argument('--use_order', dest='use_order', default=False, type=bool, 
                    help='whether use Order Strategy, default False')

parser.add_argument('--ind', dest='inductive', default=False, type=bool, 
                    help='Inductive mode, default False')

parser.add_argument('--cache', dest='cache', default=True, type=bool, 
                    help='If use cache, default True')

parser.add_argument('--remove_link_ratio', dest='remove_link_ratio', default=0.2, type=float)

parser.add_argument('--rm_feature', dest='rm_feature', default=False, type=bool, 
...
parser.add_argument('--bce', dest='BCE_mode', default=True, type=bool, 
